function __fpt_write_template_completions
    ...
    if not test -n "$plugin"
        echo "code failed: [__fpt_write_template_completions ]"
        return 1
    end
    ...
    set -q _flag_debug; and echo $ce"Debug point: [__fpt_write_template_completions ]"$cn

builtin printf -- '%s\n' \
"# completion template generated by \"fpt\"
